...
def AddForm():
    ...
    tanggal = str(cal.selection_get())
    ttk.Button(win, text="Tambah", command=lambda: addTodo(win, tanggal, jam, menit, judul, keterangan)).grid(row=6, column=0)
...
cal = Calendar(root, font='Arial 14', selectmode='day', locale='id_ID', cursor='hand1')
